...
class productsModels extends Model
{
    ...
    {
        return $this->belongsTo(categoriesModels::class, 'category_id');
    }
    ...
    {
        return $this->hasMany(pricesModels::class, 'product_id');
    }
    ...
    {
        return $this->hasMany(batchesModels::class, 'product_id');
    }
}
