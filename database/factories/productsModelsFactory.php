...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\productsModels>
 */
class productsModelsFactory extends Factory
{
    /**
     ...
     */
    protected $model = productsModels::class;

    public function definition(): array
    {
        $category = categoriesModels::inRandomOrder()->first() ?? categoriesModels::factory()->create();
